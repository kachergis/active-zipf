...
These are comprehension (recognition) estimates; computing the analogous curve directly from MacArthur-Bates CDI \textit{production} norms \citep{Frank:2017} gives a lower but still rapidly-accelerating trajectory over the age range these instruments cover--an expected productive vocabulary of roughly 7 words at 12 months, 50--120 words at 18 months (depending on instrument), and 220--530 words by 24--30 months--consistent with the general shape of early vocabulary growth, though production instruments do not extend past 30 months and so cannot speak to the age-three or age-five estimates above.
